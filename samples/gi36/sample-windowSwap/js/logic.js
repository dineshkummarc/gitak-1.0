jsx3.Package.definePackage("eg.windowswap", function(windowswap) {

  windowswap.APP;
  
  windowswap.swap = function() {
    // get the pane to be swapped,and its parent
    var swapPane = windowswap.APP.getJSXByName("blkSwappablePane");
    ...
    if (currentParent.getName() == "blkWindowSwapApp") {
      ...
      var w = windowswap.APP.getAppWindow("swapWin");
      if (w == null) {
        w = windowswap.APP.createAppWindow("swapWin");
        w.setHeight(400);
        w.setWidth(500);
