...
Description:
<P align="right"><B>Efficient Painting: version 3.0</B><BR/>
JSX version: 3.6.0</P>
...
Two strategies are used in this example: 1) use of jsx3.sleep() to give the UI a chance to breathe in between inserts, 
and 2) paintChild to efficiently add HTML to the view.
